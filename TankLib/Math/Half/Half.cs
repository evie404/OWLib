...
namespace TankLib.Math.Half {
    ...
    public struct Half : IComparable, IFormattable, IConvertible, IComparable<Half>, IEquatable<Half> {
        ...
        public bool Equals(Half other) { return other == this || IsNaN(other) && IsNaN(this); }
        ...
        public TypeCode GetTypeCode() { return (TypeCode) 255; }
        ...
        public static byte[] GetBytes(Half value) { return BitConverter.GetBytes(value.value); }
        ...
        public static ushort GetBits(Half value) { return value.value; }
        ...
        ///     minus 1.
        /// </exception>
        public static Half ToHalf(byte[] value, int startIndex) { return ToHalf((ushort) BitConverter.ToInt16(value, startIndex)); }
        ...
        public static Half ToHalf(ushort bits) { return new Half { value = bits }; }
        ...
        public static Half Abs(Half value) { return HalfHelper.Abs(value); }
        ...
        /// </returns>
        public static Half Max(Half value1, Half value2) { return value1 < value2 ? value2 : value1; }
        ...
        ///     and value2 are equal to System.Half.NaN, System.Half.NaN is returned.
        /// </returns>
        public static Half Min(Half value1, Half value2) { return value1 < value2 ? value1 : value2; }
        ...
        public static bool IsNaN(Half half) { return HalfHelper.IsNaN(half); }
        ...
        public static bool IsInfinity(Half half) { return HalfHelper.IsInfinity(half); }
        ...
        public static bool IsNegativeInfinity(Half half) { return HalfHelper.IsNegativeInfinity(half); }
        ...
        public static bool IsPositiveInfinity(Half half) { return HalfHelper.IsPositiveInfinity(half); }
        ...
        /// </exception>
        public static Half Parse(string value) { return (Half) float.Parse(value, CultureInfo.InvariantCulture); }
        ...
        ///     System.Half.MaxValue.
        /// </exception>
        public static Half Parse(string value, IFormatProvider provider) { return (Half) float.Parse(value, provider); }
        ...
        ///     System.Half.MaxValue.
        /// </exception>
        public static Half Parse(string value, NumberStyles style) { return (Half) float.Parse(value, style, CultureInfo.InvariantCulture); }
        ...
        ///     System.Half.MaxValue.
        /// </exception>
        public static Half Parse(string value, NumberStyles style, IFormatProvider provider) { return (Half) float.Parse(value, style, provider); }
        ...
        public string ToString(IFormatProvider formatProvider) { return ((float) this).ToString(formatProvider); }
        ...
        public string ToString(string format) { return ((float) this).ToString(format, CultureInfo.InvariantCulture); }
        ...
        float IConvertible.   ToSingle(IFormatProvider provider)                                   { return this; }
        TypeCode IConvertible.GetTypeCode()                                                        { return GetTypeCode(); }
        bool IConvertible.    ToBoolean(IFormatProvider  provider)                                 { return Convert.ToBoolean(this); }
        byte IConvertible.    ToByte(IFormatProvider     provider)                                 { return Convert.ToByte(this); }
        ...
        decimal IConvertible. ToDecimal(IFormatProvider  provider)                                 { return Convert.ToDecimal(this); }
        double IConvertible.  ToDouble(IFormatProvider   provider)                                 { return Convert.ToDouble(this); }
        short IConvertible.   ToInt16(IFormatProvider    provider)                                 { return Convert.ToInt16(this); }
        int IConvertible.     ToInt32(IFormatProvider    provider)                                 { return Convert.ToInt32(this); }
        long IConvertible.    ToInt64(IFormatProvider    provider)                                 { return Convert.ToInt64(this); }
        sbyte IConvertible.   ToSByte(IFormatProvider    provider)                                 { return Convert.ToSByte(this); }
        string IConvertible.  ToString(IFormatProvider   provider)                                 { return Convert.ToString(this, CultureInfo.InvariantCulture); }
        object IConvertible.  ToType(Type                conversionType, IFormatProvider provider) { return ((float) this as IConvertible).ToType(conversionType, provider); }
        ushort IConvertible.  ToUInt16(IFormatProvider   provider) { return Convert.ToUInt16(this); }
        uint IConvertible.    ToUInt32(IFormatProvider   provider) { return Convert.ToUInt32(this); }
        ulong IConvertible.   ToUInt64(IFormatProvider   provider) { return Convert.ToUInt64(this); }
