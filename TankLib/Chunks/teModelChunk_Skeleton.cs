...
namespace TankLib.Chunks {
    ...
    public class teModelChunk_Skeleton : IChunk {
        ...
        public void Parse(Stream input) {
            using (var reader = new BinaryReader(input)) {
                ...
                if (Header.Hierarchy1Offset > 0) {
                    ...
                    for (var i = 0; i < Header.BonesAbs; ++i) {
                        input.Position += 4L;
        ...
        public void GetWorldSpace(int        idx,
                                  out teVec3 scale,
                                  out teQuat rotation,
                                  out teVec3 translation) {
            var parBoneMat = Matrices34[idx];
        ...
        public Matrix GetWorldSpace(int idx) {
            GetWorldSpace(idx, out var scale, out var rotation, out var translation);
