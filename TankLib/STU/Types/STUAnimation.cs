...
namespace TankLib.STU.Types {
    ...
    public class STUAnimation : STUInstance {
        ...
        [STUField(0x4B309629, "m_animationEffect")]
        public teStructuredDataAssetRef<STUEffect> m_animationEffect;

        [STUField(0x19EFD1DB, "m_animationSettings", ReaderType = typeof(InlineInstanceFieldReader))]
        public STUAnimationSettings m_animationSettings;

        [STUField(0x563C7626, "m_compressionScale")]
        public float m_compressionScale;

        [STUField(0x38833852, "m_compressionType")]
        ...
        [STUField(0x818D011C, "m_skeleton")]
