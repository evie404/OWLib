...
namespace TankLib.STU.Types {
    ...
    public class STUGenericSettings_Ranked : STUGenericSettings_Base {
        ...
        [STUField(0x3C1894B2, "m_heroicUnlocks", ReaderType = typeof(InlineInstanceFieldReader))]
        public STUUnlocks m_heroicUnlocks;

        [STUField(0xB0670378, "m_rankedTiers", ReaderType = typeof(InlineInstanceFieldReader))]
