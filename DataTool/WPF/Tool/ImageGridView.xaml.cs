...
namespace DataTool.WPF.Tool {
    public partial class ImageGridView {
        ...
        public ImageGridEntry Add(string name,
                                  byte[] image,
                                  int    width  = 128,
                                  int    height = 128) {
        ...
        private void SelectHandler(object sender, RoutedEventArgs @event) { (ImageList.SelectedItem as ImageGridEntry)?.ClickRouter(ImageList.SelectedItem, @event); }
    }
