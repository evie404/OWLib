...
namespace DataTool.DataModels {
    ...
    public class VoiceSet {
        ...
        public VoiceSet(STUHero hero) {
            ...
            var set = GetInstance<STUVoiceSet>(voiceSetComponent.m_voiceDefinition);
            if (set == null) return;
        ...
        private void Init(STUVoiceSet voiceSet) {
            ...
            for (var i = 0; i < voiceSet.m_voiceLineInstances.Length; i++) {
                var voiceLineGuid = voiceSet.m_voiceLineGuids[i];
                var instance      = voiceSet.m_voiceLineInstances[i];

                var instanceModel = new VoiceLineInstance(instance);
                ...
                if (instance.m_voiceLineRuntime != null) {
                    ...
                    if (stimuli != 0) {
                        if (!Stimuli.ContainsKey(stimuli)) Stimuli[stimuli] = new HashSet<ulong>();
                        Stimuli[stimuli]
                            .Add(voiceLineGuid);
                    }
                }
    ...
    public class VoiceLineInstance {
        ...
        public VoiceLineInstance(STUVoiceLineInstance instance) {
            if (instance.m_AF226247 != null) {
                ...
                foreach (var soundFile in new[] { instance.m_AF226247.m_1485B834, instance.m_AF226247.m_798027DE, instance.m_AF226247.m_A84AA2B5, instance.m_AF226247.m_D872E45C })
                    if (soundFile != null)
                        voiceSounds.Add(soundFile.m_3C099E86);
                VoiceSounds = voiceSounds.ToArray();
            }

            if (instance.m_voiceLineRuntime != null) VoiceConversation = instance.m_voiceLineRuntime.m_voiceConversation;
        }
    }
}
