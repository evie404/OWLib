...
namespace TankView {
    ...
    public partial class App {
        ...
        public void SetDarkMode(bool enableDarkMode) {
            ...
            Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri($"pack://application:,,,/MaterialDesignThemes.Wpf;component/Themes/MaterialDesignTheme.{(enableDarkMode ? "Dark" : "Light")}.xaml") });
            ...
            Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/MaterialDesignColors;component/Themes/Recommended/Accent/MaterialDesignColor.DeepOrange.xaml") });
        }
    }
}
