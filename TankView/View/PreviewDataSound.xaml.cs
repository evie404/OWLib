...
namespace TankView.View {
    public partial class PreviewDataSound : UserControl, IDisposable {
        ...
        public PreviewDataSound() { InitializeComponent(); }
        ...
        private void OnStopped(object sender, StoppedEventArgs e) { CleanUp(); }
        ...
        private void Stop(object sender, RoutedEventArgs e) {
            if (outputDevice == null || outputDevice.PlaybackState == PlaybackState.Stopped) return;
        ...
        private void Pause(object sender, RoutedEventArgs e) {
            if (outputDevice == null || outputDevice.PlaybackState == PlaybackState.Paused) return;
