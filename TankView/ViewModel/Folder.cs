...
namespace TankView.ViewModel {
    public class Folder {
        ...
        public bool HasFolder(string part) { return Folders.Any(x => x.Name.Equals(part, StringComparison.InvariantCultureIgnoreCase)); }

        public void Add(string part) {
            if (!HasFolder(part)) Folders.Add(new Folder(part, Path.Combine(FullPath, part)));
        }
    }
}
